...
sends feedback to a Google Apps Script webhook.
"""
...
st.set_page_config(
    page_title="Owner Sales Performance",
    page_icon="📞",
    layout="wide",
    ...
    st.markdown(
        ...
        <div class="topbar">
          <div class="brand">
            ...
            <div>
              <div class="brand-name">Owner Sales Coach</div>
              <div class="brand-sub">Call quality · Coaching · Conversion</div>
            </div>
          </div>
        </div>
        """,
    ...
    st.markdown(
        ...
        <div class="login-shell">
          <div class="login-hero">
            <div class="brand-logo">OS</div>
            <div class="login-big">A cleaner coaching dashboard for Owner Sales.</div>
            <div class="login-copy">
              Private agent view. Focuses on clear strengths, priority coaching moments, and call evidence — without overwhelming the user.
            </div>
            <div class="hero-pills">
          ...
          <div class="login-card">
            ...
            <div class="login-card-copy">Enter your name or employee ID. Use full name if your first name is shared with another agent.</div>
          </div>
        </div>
        """,
        unsafe_allow_html=True,
